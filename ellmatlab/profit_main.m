...
[yb1, fb, iter, feasible, status] = ellipsoid_dc(@P.evaluate, E, 0, 200, 1e-4);
fb
iter
...
[yb1, fb, iter, feasible, status] = ellipsoid_discrete(@P.evaluate, E, 0, 200, 1e-4);
fb
x = exp(yb1)
iter
...
% [yb, fb, iter, feasible, status] = ellipsoid_dc(@P.evaluate, E, Inf, 200, 1e-4);
% fb2 = exp(-fb)
% iter